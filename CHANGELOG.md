...
- Mobile Formulare, Fokusmarkierung und aktiven Navigationsstatus verbessert.
- Dokumentation gegliedert, historische Reviews archiviert und Versionsmetadaten synchronisiert.
- Repository-Qualitätstests ergänzt; bestehende Funktionen und Sicherheitsgrenzen erhalten.
...
- öffentlicher Markt-WebSocket akzeptiert neben EUR auch USD-notierte Märkte
- neue dev.48-Integritätsregressionen; Realhandel bleibt hart deaktiviert
## 0.1.0-dev.47
...
- Realhandel bleibt hart deaktiviert
## 0.1.0-dev.51
- Steuerinfo Österreich mit Jahresbericht, CSV, Audit und Fail-closed-Prüfhinweisen
