# Changelog
## 0.1.0-dev.51
- sichtbare UTF-8-BeschÃ¤digungen in Quelltexten, Tests und Dokumentation vollstÃ¤ndig repariert
- Monitoring als erster Flask-Blueprint modularisiert
- neues filterbares Ereignis-Dashboard fÃ¼r Fehler, Warnungen und Benutzernachrichten
- Audit-Export als redigierte JSON- oder CSV-API ergÃ¤nzt
- WebSocket-Start fÃ¼r isolierte Tests explizit deaktivierbar gemacht
- neue Sicherheits- und Regressionstests; Realhandel bleibt hart deaktiviert
## 0.1.0-dev.51
- sichtbare Mojibake-Reste in Quelltexten, Tests und Projektdokumentation vollstÃ¤ndig repariert
...
- Ã¶ffentlicher Markt-WebSocket akzeptiert neben EUR auch USD-notierte MÃ¤rkte
- neue dev.48-IntegritÃ¤tsregressionen; Realhandel bleibt hart deaktiviert
## 0.1.0-dev.47
- Laufzeitfehler der Seite Kontrolliertes Lernen durch fehlenden FAMILIES-Import behoben
- Nachrichten-Lernen zeigt Datenbestand, gÃ¼ltige, ungÃ¼ltige und unverarbeitete AI-Auswertungen
- Vergleich bleibt bis zur erforderlichen gÃ¼ltigen Stichprobe gesperrt und erklÃ¤rt den konkreten Grund
- separate Aktion "AI auswerten" ergÃ¤nzt; keine automatische Parameteraktivierung
- neue Regressions- und Diagnosetests; Realhandel bleibt hart deaktiviert
## 0.1.0-dev.46
- LernfamilienÃ¼bersicht zeigt aktive Version, offene Kandidaten und letzten Kandidatenstatus je Familie
- Familiennavigation bleibt direkt auswÃ¤hlbar und Detaildaten bleiben gefiltert
- unbekannte Familienparameter fallen kontrolliert auf Forex zurÃ¼ck
...
- Familiennamen sind direkt auswÃ¤hlbar
- Kandidaten, Versionshistorie und Horizontmetriken werden auf die gewÃ¤hlte Familie gefiltert
- Regressionstests fÃ¼r FamilienÃ¼bersicht und Filterung ergÃ¤nzt
...
- Realhandel bleibt hart deaktiviert
## 0.1.0-dev.51
- Steuerinfo Ã–sterreich mit Jahresbericht, CSV, Audit und Fail-closed-PrÃ¼fhinweisen
...
- Live-Ausführung bleibt standardmäßig deaktiviert und fail-closed
