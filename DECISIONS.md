...
## 2026-08-28 D071
Dev.57 zentralisiert das GUI-Grundlayout und Stylesheet, behält bestehende Routen und Fachfunktionen jedoch unverändert bei. Verbindliche Projektverträge bleiben im Repository-Stamm; erklärende Dokumentation liegt unter `docs/`.
