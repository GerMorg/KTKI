...
VollstÃ¤ndige LernversionsÃ¼bersicht mit familienbezogener Navigation und konsistent gefilterten Detaildaten.
...
StabilitÃ¤tsrelease fÃ¼r kontrolliertes Lernen und Nachrichten-Lernen mit transparenten Datenstatus- und Wiederherstellungswegen.

## 0.1.0-dev.51 - 2026-08-28
IntegritÃ¤tsrelease: UTF-8-Quellen bereinigt, Versionsmetadaten synchronisiert, GUI-Bezeichnung konsistent und USD-WebSocket-Abdeckung repariert. Realhandel bleibt hart deaktiviert.

## 0.1.0-dev.51
Monitoring-Blueprint, Ereignis-Dashboard, redigierter Audit-Export und vollstÃ¤ndige UTF-8-Reparatur.
## 0.1.0-dev.51
Steuerinfo Ã–sterreich; Realhandel bleibt hart deaktiviert.
## 0.1.0-dev.51
Abgesicherte Realhandels-Grundstufe mit standardmäßigem Validate-only-Modus.
