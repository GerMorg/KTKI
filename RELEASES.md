...
## 0.1.0-dev.51
Steuerinfo Österreich; Realhandel bleibt hart deaktiviert.
## 0.1.0-dev.51
Abgesicherte Realhandels-Grundstufe mit standardmäßigem Validate-only-Modus.

## 0.1.0-dev.57 — 2026-08-28
Struktur- und Qualitätsrelease mit zentralem GUI-Layout, externem Stylesheet, UTF-8-Reparatur, konsistenter Dokumentation und automatischen Repository-Prüfungen. Bestehende Funktionen und Sicherheitsgrenzen bleiben erhalten.
