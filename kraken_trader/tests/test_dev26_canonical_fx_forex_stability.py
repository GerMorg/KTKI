...
class T(unittest.TestCase):
 ...
 def test_forex_pairs_uses_asset_class(self):
  k=KrakenClient()
  with patch.object(k,'call',return_value={}) as c:k.pairs('forex');self.assertEqual(c.call_args.args[1]['asset_class'],'forex');self.assertNotIn('aclass_base',c.call_args.args[1])
