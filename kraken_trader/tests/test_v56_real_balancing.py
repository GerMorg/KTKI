...
class T(unittest.TestCase):
 def setUp(self):
  ...
  with self.db.con() as c:
   c.execute('CREATE TABLE scanner_results(symbol TEXT,score TEXT,quality TEXT,signal TEXT)');c.execute("INSERT INTO scanner_results VALUES('BTC/EUR','90','VALID','BUY')");c.execute("INSERT INTO live_prices VALUES('BTC/EUR','50000','49900','50100','0',CURRENT_TIMESTAMP)");c.execute("INSERT INTO private_balances VALUES('EUR','1000','[]',1,CURRENT_TIMESTAMP)")
