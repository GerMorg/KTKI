...
class AutomationController:
    ...
    def ensure(self):
        with self.db.con() as c:
            ...
            try:c.execute('''INSERT INTO automation_runs(created_at,subsystem,status,automatic,details_json,error) SELECT created_at,subsystem,status,automatic,details_json,error FROM automation_runs_v67 WHERE NOT EXISTS (SELECT 1 FROM automation_runs)''')
