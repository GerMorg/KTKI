...
class ForexShadow:
 ...
 def score(self,symbol,active):
  ...
  for horizon,hvalue in horizons.items():
   ...
   why=['forex-v2 shadow, keine Handelswirkung',f'Relative WÃƒÂ¤hrungsstÃƒÂ¤rke {relative:.4f}',f'Risiko-/Safe-Haven-Regime {risk_regime:.2f}',f'Zeithorizont {horizon}',f'Paarbezogene Nachrichten {news_count}']
