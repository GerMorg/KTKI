...
LABELS={'xstocks_base_score':'Basiswert','xstocks_momentum_weight':'Momentum-Gewicht','xstocks_trend_weight':'Trend-Gewicht','xstocks_volatility_penalty':'VolatilitÃƒÂ¤tsabzug','xstocks_spread_penalty':'Spread-Abzug','xstocks_buy_threshold':'BUY-Schwelle','xstocks_buy_max_spread_pct':'Maximaler BUY-Spread %','xstocks_avoid_threshold':'AVOID-Schwelle','xstocks_avoid_spread_pct':'AVOID-Spread %'}
