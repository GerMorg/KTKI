...
class KrakenClient:
 ...
 def call(self,path,data=None,private=False):
  data=dict(data or {});headers={"User-Agent":"HA-Kraken-Trader/0.1.0-dev.8"}
  if private:
 ...
 def ohlc(self,pair,interval=60):return self.call('/0/public/OHLC',{'pair':pair,'interval':int(interval)})
