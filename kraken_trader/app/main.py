...
def controlled_learning_page():
 ...
 candidates=controlled_learning.candidates();versions=controlled_learning.versions();learning_metrics=controlled_learning.metrics();gate_policy=controlled_learning.gate_policy();active=controlled_learning.active(family);active_params=json.loads(active['parameters_json']) if active else {}
 views=[]
