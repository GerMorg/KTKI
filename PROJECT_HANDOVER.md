...
## Dev.46
Die Lernseite zeigt je Familie aktive Version, offene Kandidaten und letzten Kandidatenstatus. Unbekannte Familienwerte werden fail-closed auf Forex normalisiert. NÃ¤chster Hauptschritt bleibt die mehrfenstrige Walk-forward-StabilitÃ¤t.

## Dev.47
Kontrolliertes Lernen ist durch den fehlenden FAMILIES-Import wieder erreichbar. Nachrichten-Lernen unterscheidet fehlende Nachrichten, fehlende gÃ¼ltige AI-Ergebnisse und eine zu kleine Stichprobe. Die Mindeststichprobe bleibt unverÃ¤ndert und fail-closed.


## Stand dev.48
UTF-8- und Versionsinkonsistenzen des dev.47-Snapshots sind behoben. Der Ã¶ffentliche WebSocket berÃ¼cksichtigt EUR- und USD-notierte MÃ¤rkte. SÃ¤mtliche bisherigen Sicherheitsgrenzen und Funktionen bleiben erhalten.

## Ãœbergabe dev.49
Monitoring ist als erster Blueprint ausgelagert. Ereignis-Dashboard und redigierter Audit-Export sind implementiert. WebSockets kÃ¶nnen in isolierten Tests Ã¼ber APP_DISABLE_WEBSOCKETS=1 unterdrÃ¼ckt werden. Alle bestehenden Funktionen und Sicherheitsgrenzen bleiben erhalten.
